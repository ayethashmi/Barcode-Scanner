...
class DevAppsBookActionsFragmentDevAppsDevApps: DevAppsAbstractActionsFragmentDevApps() {
    ...
    private fun showUrlsAlertDialog(contents: String): ActionItem.OnActionItemListener = object : ActionItem.OnActionItemListener {
        override fun onItemClick(view: View?) {
            ...
            val items = arrayOf<Triple<String, Int, ActionItem.OnActionItemListener>>(
                ...
                Triple(getString(R.string.action_product_search_label, getString(R.string.open_library_label)), R.drawable.ic_book_24, openUrl(openLibraryUrl))
            )
