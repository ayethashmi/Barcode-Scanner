...
import com.devappspros.barcodescanner.databinding.FragmentBarcodeFormCreatorQrUrlBinding

/**
 * A simple [Fragment] subclass.
 */
class DevAppsBarcodeFormCreatorQrUrlFragmentDevApps : DevAppsAbstractBarcodeFormCreatorQrFragment() {
    ...
    override val checkError: (contents: String) -> String? by lazy {
        { devAppsBarcodeFormatChecker.checkQrUrlError(it) }
    }
}