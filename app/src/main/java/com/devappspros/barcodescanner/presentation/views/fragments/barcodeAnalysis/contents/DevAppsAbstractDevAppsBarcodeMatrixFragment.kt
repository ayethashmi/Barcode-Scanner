...
abstract class DevAppsAbstractDevAppsBarcodeMatrixFragment : DevAppsBarcodeAnalysisFragment<DevAppsBarcodeAnalysis>() {
    ...
    abstract fun start(product: DevAppsBarcodeAnalysis, parsedResult: ParsedResult)
}